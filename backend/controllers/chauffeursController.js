...
const createChauffeur = async (req, res) => {
    ...
    try {
        ...
        // Create the user
        const chauffeur = await Chauffeur.create({ email, firstName, lastName, age, sex, contactNumber, location, description, pricePerHour,  carMake, carModel, carYear, image});
